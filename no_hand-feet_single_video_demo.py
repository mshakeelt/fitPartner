from core.inference import TRT_Infer_Body
...
def draw_inference(image):
    trt_keypoints = trt_infer_body.execute(image)  
...
if __name__ == '__main__':
    ...
    colors = set_colors()
    draw_graphics = Graphics(colors=colors, comparison_level=body_part.lower(), hands=False, feet=False)        
